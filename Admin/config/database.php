...
class Database
{
    private const HOST = 'localhost:3307';
    private const USERNAME = 'root';
    private const PASSWORD = '27112002';
    private const DBNAME = 'bookstore';
    ...
    {
        $countAllResult = self::GetData('SELECT count(*) FROM genre');
        $countAll = $countAllResult[0]['count(*)'];
